...
# Basically, what does this entire code is search for the similar picture we used as our needle
...
# Clicks on the center of an image with a slight random offset to avoid anti-bot monitoring. ############################
